...
export const morningMoment: Moment = {
  id: "comfort",
  text: "동화책 낭독 시간📖",
  caption: "오늘 오전에는 선생님과 친구들 모두 함께 동화책 낭독 시간을 가졌어요.야쿤이는 친구들과 나란히 앉아 선생님이 들려주시는 동화 이야기를 아주 집중해서 들어주었답니다. 재미있는 장면이 나오자 귀를 쫑긋 세우고 책을 바라보기도 하고, 꼬리도 살랑살랑 흔들었어요. 처음 듣는 동화책이 재밌었나봅니다 ㅎㅎ 오전부터 차분하고 즐거운 시간을 보내며 기분 좋게 하루를 시작했어요. 🐾🌼",
  fallback: "동화책 야쿤",
