...
export const afternoonMoments: Moment[] = [
  {
    id: "rest",
    text: "무비나잇 야쿤🎥",
    caption: "오후에는 폭신한 쿠션에 편하게 앉아 맛있는 간식과 함께 친구들과 함께 무비나잇 시간을 가졌어요. 야쿤이는 영화가 시작되자 친구들과 나란히 앉아 화면을 바라보며 집중해서 감상했답니다. 재미있는 장면이 나오면 친구들과 함께 즐겁게 웃기도 하고, 편안한 분위기 속에서 간식도 맛있게 먹으며 영화에 푹 빠져 있었어요. 🍿🐶",
    fallback: "무비나잇 야쿤",
