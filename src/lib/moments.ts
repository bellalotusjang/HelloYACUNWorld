...
export const afternoonMoments: Moment[] = [
  {
    ...
    caption: "다른 친구들이 별자리를 찾으며 즐겁게 이야기하는 동안, 야쿤이는 가장 밝게 빛나는 별을 한참 동안 바라보고 있었어요. 하늘을 향해 꼬리를 살랑살랑 흔드는 모습을 보니, 오늘은 아빠가 많이 보고 싶은가 봅니다. 그래도 친구들과 함께 따뜻한 시간을 보내며 편안하게 하루를 마무리했습니다. 내일도 야쿤이가 행복한 하루를 보낼 수 있도록 저희가 곁에서 잘 돌보겠습니다. 🌙🤍",
