...
export const morningMoment: Moment = {
  id: "comfort",
  text: "새싹놀이 🌱",
  caption: "오늘은 친구들과 함께 작은 화분에 심어진 새싹을 돌보아 주었어요. 야쿤이는 선생님과 함께 새싹에 물을 조심조심 주며 잘 자라고 있는지 살펴보았답니다. 오늘은 야쿤이가 머리에 리본을 달아달라고 선생님에게 부탁했어요. 아빠가 예전에 예쁘게 묶어주시던 리본이라며, 아빠한테 예쁘게 보이고 싶다고 하더라구요. 리본을 하고 나니 야쿤이 외모가 더 빛나는 거 있죠? 🤍",
  fallback: "새싹과 야쿤",
